...
public class Collections02Test {
    ...
    /**
     * Gerade Anzahl von int's, die zu keiner {@link ArithmeticException} führen dürfen.
     */
    private static List<Integer> aListGerade = Arrays.asList(aGerade);
    /**
     * Ungerade Anzahl von int's, die zu keiner {@link ArithmeticException} führen dürfen.
     */
     ...
     * die zu keiner {@link ArithmeticException} führen dürfen.
     */
    private static List<Integer> aListMaxMin1 = Arrays.asList(aMaxMin1);
    /**
     * Betragsmäßig große int's mit unterschiedlichen Vorzeichen,
     * die zu einer {@link ArithmeticException} führen müssen.
     */
    private static List<Integer> aListMaxMin2 = Arrays.asList(aMaxMin2);
    /**
     * Betragsmäßig große int's mit unterschiedlichen Vorzeichen,
     * die je nach Implementierung zu einer {@link ArithmeticException} führen oder nicht.
     */
    private static List<Integer> aListMax1 = Arrays.asList(aMax1);
    /**
     * Eine Liste der size {@link Integer#MAX_VALUE}. Dient zum Testen von Aufgabenteil 1.
     */
